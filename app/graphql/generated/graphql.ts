...
export type ItemManyWhereInput = {
  ...
  /** All values ending with the given string. */
  flag_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are contained in given list. */
  flag_in?: InputMaybe<Array<Scalars['String']>>;
  /** All values that are not equal to given value. */
  flag_not?: InputMaybe<Scalars['String']>;
  /** All values not containing the given string. */
  flag_not_contains?: InputMaybe<Scalars['String']>;
  /** All values not ending with the given string */
  flag_not_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are not contained in given list. */
  flag_not_in?: InputMaybe<Array<Scalars['String']>>;
  /** All values not starting with the given string. */
  flag_not_starts_with?: InputMaybe<Scalars['String']>;
  /** All values starting with the given string. */
  flag_starts_with?: InputMaybe<Scalars['String']>;
  id?: InputMaybe<Scalars['ID']>;
  /** All values containing the given string. */
  id_contains?: InputMaybe<Scalars['ID']>;
  /** All values ending with the given string. */
  ...
  /** All values that are contained in given list. */
  phrase_in?: InputMaybe<Array<Scalars['String']>>;
  /** All values that are not equal to given value. */
  ...
  /** All values that are not contained in given list. */
  phrase_not_in?: InputMaybe<Array<Scalars['String']>>;
  /** All values not starting with the given string. */
...
export type GetPhrasesQuery = { __typename?: 'Query', items: Array<{ __typename?: 'Item', id: string, flag: string, language: string, phrase: string }> };
